...
{
    public abstract class NishilPortWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static NishilPortWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(NishilPortWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<NishilPortDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<NishilPortDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<NishilPortDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<NishilPortDbContext, Task<T>> func)
        {
            T result;
